    ...
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-md p-8 border-white/60 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-black text-slate-800 tracking-tight text-center">Masuk ke POS</h1>
          <p className="text-slate-500 font-medium text-center mt-2">Kelola warung Anda dari mana saja.</p>
        </div>
        ...
        <div className="relative z-10 text-center mt-4 pt-4 border-t border-slate-100">
          <Link href="/admin" className="text-xs text-slate-300 hover:text-slate-400 font-medium transition-colors">
            Developer Access
          </Link>
        </div>
      </div>
